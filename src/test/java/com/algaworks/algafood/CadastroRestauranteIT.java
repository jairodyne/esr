...
//
//		Restaurante restauranteLoxas = new Restaurante();
//		restauranteLoxas.setNome("Restaurante Loxas");
//		restauranteLoxas.setTaxaFrete(new BigDecimal(5));
//		restauranteLoxas.setCozinha(cozinha3);
//		restauranteRepository.save(restauranteLoxas);
