...
@ApiModel("Problema")
@JsonInclude(Include.NON_NULL)  // só inclui a propriedade preenchida (non null )
@Getter
@Builder
public class Problem {
	...
	@ApiModelProperty(example = "Um ou mais campos estão inválidos. Faça o preenchimento correto blá, blá blá ...", position = 20)
	private String detail;

	@ApiModelProperty(example = "Um ou mais campos estão inválidos. Faça o preenchimento correto blá, blá blá ...", position = 25)
