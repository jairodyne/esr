...
insert into permissao (id, nome, descricao) values (4, 'ABRIR_RESTAURANTES', 'Permite fazer a abertura de restaurantes');
insert into permissao (id, nome, descricao) values (5, 'FECHAR_RESTAURANTES', 'Permite fazer o fechamento de restaurantes');
...
insert into grupo (nome) values ('Diretor'), ('Gerente'), ('Secretária'), ('Vendedor'), ('Aspone');
...
insert into restaurante_usuario_responsavel (restaurante_id, usuario_id) values (1, 1), (1, 2), (2, 3), (3, 4), (4, 3); 
